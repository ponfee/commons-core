...
public class CharacterEncodingDetector {
    ...
    private static class BytesEncodingDetect extends Encoding {
        ...
        public int detectEncoding(byte[] rawtext) {
            ...
            int encoding_guess = Encoding.DEFAULT;
            scores = new int[Encoding.TOTAL_TYPES];
            // Assign Scores
            ...
            if (maxscore <= 50) {
                encoding_guess = Encoding.DEFAULT;
            }
    ...
    private static class Encoding {
        ...
        static {
            ...
            JAVA_CHARSET[DEFAULT]       = DEFAULT_ENCODING;
            ...
            HTML_CHARSET[DEFAULT]       = DEFAULT_ENCODING;
            ...
            NICE_CHARSET[DEFAULT]       = DEFAULT_ENCODING;
        }
    }
}
