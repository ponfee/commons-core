...
public class CharsetDetector {
    ...
    public static Charset detect(InputStream input, int length) throws IOException {
        //return code.ponfee.commons.io.charset.CodepageDetector.detect(input, length);
        //return code.ponfee.commons.io.charset.JchardetDetector.detect(input, length);
        //return code.ponfee.commons.io.charset.BytesDetector.detect(input, length);
        return code.ponfee.commons.io.charset.TikaDetector.detect(input, length);
    }
