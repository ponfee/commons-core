...
public enum Currencys {
     ...
     */
    Currencys(String currencySymbol) {
        this.currencyCode = this.name();
        this.currencySymbol = currencySymbol;
        this.currency = Currency.getInstance(this.currencyCode);
        this.countryCode = String.format("%03d",this.currency.getNumericCode());
        ...
        Hide.CURRENCY_CODES.put(this.currencyCode, this);
        Hide.COUNTRY_CODES.put(this.countryCode, this);
    }
     ...
     * @return Currencys
     */
    public static Currencys ofCurrencyCode(String currencyCode) {
        return Hide.CURRENCY_CODES.get(currencyCode);
    }

    /**
     * Returns Currencys by country code
     *
     * @param countryCode the country code
     * @return Currencys
     */
    public static Currencys ofCountryCode(String countryCode) {
        return Hide.COUNTRY_CODES.get(countryCode);
    }
    ...
    public static Currencys of(Currency currency) {
        return Hide.CURRENCY_CODES.get(currency.getCurrencyCode());
    }

    private static class Hide {
        private static final Map<String, Currencys> CURRENCY_CODES = new HashMap<>();
        private static final Map<String, Currencys> COUNTRY_CODES = new HashMap<>();
    }
