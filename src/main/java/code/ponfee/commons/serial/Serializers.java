...
public enum Serializers {
    ...
    BOOLEAN(boolean.class, Boolean.class) {
        protected @Override byte[] toBytes0(Object value) {
            return new byte[] { (Boolean) value ? BOOL_TRUE_BYTE : BOOL_FALSE_BYTE };
        }

        public @Override <T> T ofBytes(byte[] value) {
    ...
    protected abstract byte[] toBytes0(Object value);
