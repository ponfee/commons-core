...
public class ELParserTest {
    ...
    public static void main(String[] args) {
        ...
        String params = "{\"from\":0,\"size\":5000,\"query\":{\"bool\":{\"must\":[{\"range\":{\"statEndTime\":{\"from\":$[start_year(timestamp)],\"to\":$[end_day(timestamp)],\"include_lower\":true,\"include_upper\":true}}},{\"terms\":{\"companyName\":[\"华北仓配中心\",\"华东仓配中心\",\"华南仓配中心\",\"华西仓配中心\",\"中南仓配中心\"]}}]}}}";
