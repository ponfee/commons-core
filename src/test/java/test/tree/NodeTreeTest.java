...
public class NodeTreeTest {
    ...
    @Test
    public void test1() {
        List<BaseNode<String, Integer, String>> list = new ArrayList<>();
        list.add(new BaseNode<>("100000", null, 1, true, "nid100000"));
        list.add(new BaseNode<>("100010", "100000", 1, true, "nid100010"));
        list.add(new BaseNode<>("100011", "100010", 1, false, "nid100011"));
        list.add(new BaseNode<>("100012", "100010", 1, true, "nid100012"));
        list.add(new BaseNode<>("100020", "100000", 1, false, "nid100020"));
        list.add(new BaseNode<>("100021", "100020", 1, true, "nid100020"));
        list.add(new BaseNode<>("100022", "100020", 1, false, "nid100022"));
        ...
        TreeNode<String, Integer, String> subtree = TreeNode.createRoot("400010", "400000", 1, true);
        List<BaseNode<String, Integer, String>> list1 = new ArrayList<>();
        ...
        TreeNode<String, Integer, String> root = TreeNode.createRoot(TreeNode.DEFAULT_ROOT_ID);
